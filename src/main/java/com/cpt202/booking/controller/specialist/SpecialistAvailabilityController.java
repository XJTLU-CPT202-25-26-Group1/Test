...
public class SpecialistAvailabilityController {
    ...
    public SpecialistAvailabilityController(AvailabilityService availabilityService, SpecialistService specialistService) {
    ...
    public String availabilityPage(Model model) {
        ...
        model.addAttribute("specialist", specialistService.getAllSpecialists().get(0));
        model.addAttribute("slots", availabilityService.getSlotsForSpecialist(specialistId));
        return "specialist/availability";
    }

    @PostMapping
    public String createSlot(@RequestParam String date,
